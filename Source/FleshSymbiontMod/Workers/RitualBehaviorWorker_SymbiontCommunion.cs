...
namespace FleshSymbiontMod
{
    ...
    public class RitualBehaviorWorker_SymbiontCommunion : RitualBehaviorWorker
    {
        ...
        private void SendCompletionMessage(int participantCount, int symbiontCount)
        {
            ...
            {
                message = $"The communion ritual reaches its crescendo as {participantCount} worshippers unite their consciousness " +
            ...
            {
                message = $"The symbiont communion concludes. {participantCount} participants shared consciousness with " +
            ...
            {
                message = "Symbiont communion ritual completed successfully.";
            }
            
            if (!string.IsNullOrEmpty(message))
            {
                Messages.Message(message, MessageTypeDefOf.RitualCompleted);
            }
        }
